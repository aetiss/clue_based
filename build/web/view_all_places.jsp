        ...
        <div class="s-promo-block-user">
            ...
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-100--xs">
                    <h2 style="color: white">Place Details</h2>
<div class="panel-body table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">View Location</th>
                                    </tr>
                                </thead>
        ...
        <tbody>
                                    <tr class="edit" id="detail">
                                        ...
                                        <td id="mobile" class="text-center"><%=rs.getString("p_state")%></td>
                                        <td id="mail" class="text-center"><%=rs.getString("address")%></td>
                                        <td id="city" class="text-center "><textarea readonly="" cols="20" rows="4" style=" width: 373px; height: 142px;"><%=rs.getString("des")%></textarea></td>
                                        ...
                                        <td id="city" class="text-center"><a class="btn btn-info parents tablodugmeler pull-right" href="view_loc.jsp?loc=<%=rs.getString("address")%>">View Location</a></td>
                                    </tr>
                                </tbody>
