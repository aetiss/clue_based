        ...
        <div class="s-promo-block-user">
            <div class="g-container--sm g-text-center--xs g-padding-y-80--xs g-padding-y-125--xsm">
                <div class="g-margin-b-60--xs">
                    <h2 class="g-font-size-32--xs g-font-size-36--md g-letter-spacing--1 g-color--white">Top Rated</h2>
                </div>
            </div>
        </div>
        <div class="g-position--relative s-promo-block-user">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="row"><%
                                ...
                                try {
                                    ResultSet rs = st.executeQuery("SELECT review.p_id,places.p_name,places.p_city,places.p_state,places.avg from places inner join review on places.id = review.p_id group by review.p_id order by places.avg desc");
                                    while(rs.next()) {
                            %>
                            <div class="col-sm-3 g-margin-b-20--xs" style="height:600px">
                        
                            <article>
                            <img class="img-responsive" src="pic.jsp?uid=<%=rs.getString("p_id")%>" alt="Image">
                            <div class="g-bg-color--white g-box-shadow__dark-lightest-v2 g-text-center--xs g-padding-x-40--xs g-padding-y-40--xs">
                                <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2"></p>
                                <h2 class="g-font-size-18--xs g-font-family--playfair g-letter-spacing--1"><a href="view_details.jsp?pid=<%=rs.getString("p_id")%>&city=<%=rs.getString("p_city")%>"><%=rs.getString("p_name")%></a></h2>
                                <p style="color: black"><strong>Rating&nbsp;====>>&nbsp;&nbsp;<%=rs.getString("avg")%></strong></p>
                                <p style="color: black"><strong>City&nbsp;&nbsp;====>>&nbsp;&nbsp;<%=rs.getString("p_city")%></strong></p>
                            </div>
                        </article>    <!-- End News -->
                    </div>
                            <%                                        }
