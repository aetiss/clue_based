...
<div class="panel-body table-responsive">
        ...
        <tbody>
                                    <tr class="edit" id="detail">
                                        ...
                                        <td id="city" class="text-center"><%=rs.getString("email")%></td>
                                        <td id="city" class="text-center"><a class="btn btn-info parents tablodugmeler pull-right" href="view_loc.jsp?loc=<%=rs.getString("cur_address")%>"><%=rs.getString("cur_address")%></a></td>
                                    </tr>
                                </tbody>
