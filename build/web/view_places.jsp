        ...
        <div class="s-promo-block-user">
            <div class="g-container--sm g-text-center--xs g-padding-y-80--xs g-padding-y-125--xsm">
                <div class="g-margin-b-60--xs">
                    <h2 class="g-font-size-32--xs g-font-size-36--md g-letter-spacing--1 g-color--white">Search Places</h2>
                </div>
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        <form class="input-group" action="searched_places.jsp" method="post" >
                            <input type="text" class="form-control s-form-v1__input g-radius--left-50" name="search" placeholder="Search Places Here">
                            <span class="input-group-btn">
                                <button type="submit" class="s-btn s-btn-icon--md s-btn-icon--white-brd s-btn--white-brd g-radius--right-50"><i class="ti-search"></i></button>
                            </span>
                        </form>
                    </div>
                </div>
        ...
        <div class="g-position--relative s-promo-block-user">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-60--xs">
                    <p class="text-uppercase g-font-size-14--xs g-font-weight--700 g-color--primary g-letter-spacing--2">All Places</p>
                </div>
                <div class="row"><%
                            ...
                            <article>
                            <img class="img-responsive" src="pic.jsp?uid=<%=rs.getString("id")%>" alt="Image">
