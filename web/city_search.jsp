                ...
                <nav class="s-header__nav js__scrollbar">
                    <div class="container-fluid">
                        ...
                        <ul class="list-unstyled s-header__nav-menu">
                            <li class="s-header__nav-menu-item"><a class="s-header__nav-menu-link s-header__nav-menu-link-divider" href="user_">User Home</a></li>
        ...
        <div class="s-promo-block-user">
            <div class="g-container--sm g-text-center--xs g-padding-y-80--xs g-padding-y-125--xsm">
                <div class="g-margin-b-60--xs">
                    <h2 class="g-font-size-32--xs g-font-size-36--md g-letter-spacing--1 g-color--white">Searched Result</h2>
                </div>
            </div>
        </div>
        <div class="g-position--relative s-promo-block-user">
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="row"><%
                                ...
                                try {
                                    int i = st.executeUpdate("insert into city_search (search,time,uid, uname)values('" + search + "','" + time + "','" + uid + "','" + uname + "')");
                                    ResultSet rs = st.executeQuery("SELECT * FROM places where p_state LIKE '%" + search + "%' OR p_city LIKE '%" + search + "%' ");
                                    while(rs.next()) {
                            %>
