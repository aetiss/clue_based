        ...
        <div class="g-position--relative g-bg-color--primary">
            <div class="g-container--md g-padding-y-125--xs">
                <div class="g-text-center--xs g-margin-t-50--xs g-margin-b-80--xs">
                    <p class="text-uppercase g-font-size-50--lg g-font-weight--700 g-color--white-opacity g-letter-spacing--2 g-margin-b-25--xs">OTP Verification</p>
                    <img class="" src="img/otp_1.png" alt="Mockup Image" width="300px">
                </div>
                <form class="center-block g-width-500--sm g-width-550--md" action="otp1.jsp" method="post">
                    <div class="g-margin-b-30--xs">
                        <input type="password" name="votp" class="form-control s-form-v3__input" placeholder="* Enter Your 8 digit OTP">
                    </div>
            ...
            <img class="s-mockup-v2" src="img/ver.png" alt="Mockup Image">
        </div>
        <!-- End Feedback Form -->
        <!--========== END PAGE CONTENT ==========-->
