        ...
        <div class="s-promo-block-user">
            ...
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-100--xs">
                    <h2 style="color: white">Trajectories Details</h2>
<div class="panel-body table-responsive">
                            <table class="table table-hover">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center">View Trajectory</th>
                                    </tr>
                                </thead>
        <%   //String uid = (String) session.getAttribute("uid");
            ...
            try {
                ResultSet rs = st.executeQuery("SELECT * FROM trajectory");
                while(rs.next()) {
        %>
        <tbody>
                                    <tr class="edit" id="detail">
                                        <td id="name" class="text-center"><%=rs.getString("place_id")%></td>
                                        <td id="mobile" class="text-center"><%=rs.getString("user_id")%></td>
                                        <td id="mail" class="text-center"><%=rs.getString("user_name")%></td>
                                        <td id="city" class="text-center"><%=rs.getString("source")%></td>
                                        <td id="city" class="text-center"><%=rs.getString("dest")%></td>
                                        <td id="city" class="text-center"><a class="btn btn-info parents tablodugmeler pull-right" href="trajec_location.jsp?source=<%=rs.getString("source")%>&dest=<%=rs.getString("dest")%>">Trajectory Path</a></td>
                                    </tr>
                                </tbody>
