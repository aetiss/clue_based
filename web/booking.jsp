...
<div class="panel-body table-responsive">
        ...
        <%   //String uid = (String) session.getAttribute("uid");
            ...
            try {
                ResultSet rs = st.executeQuery("SELECT * FROM booking where rate ='waiting'");
                while(rs.next()) {
        %>
        <tbody>
                                    <tr class="edit" id="detail">
                                        <td id="name" class="text-center"><%=rs.getString("uid")%></td>
                                        <td id="city" class="text-center"><%=rs.getString("uname")%></td>
                                        <td id="city" class="text-center"><%=rs.getString("pid")%></td>
                                        <td id="city" class="text-center"><%=rs.getString("pname")%></td>
                                        <td id="city" class="text-center"><%=rs.getString("address")%></td>
                                        <td id="city" class="text-center"><%=rs.getString("vehicle")%></td>
                                        <td id="city" class="text-center"><%=rs.getString("members")%></td>
                                        <td id="city" class="text-center"><%=rs.getString("days")%></td>
                                        <td id="city" class="text-center"><%=rs.getString("pick_up")%></td>
        <form action="rate.jsp" method="get">
                                        <td id="city" class="text-center"><input type="text" name="rate" ></td> 
        <input name="id" hidden="" value="<%=rs.getString("id")%>">
        <input name="uid" hidden="" value="<%=rs.getString("uid")%>">
                                        <td id="city" class="text-center"><button type="submit"> Send</button></td> 
        </form>
                                    </tr>
                                </tbody>
