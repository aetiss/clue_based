...
<html lang="en" class="no-js">
    ...
    <body>
        ...
        <div class="s-promo-block-user">
            ...
            <div class="container g-padding-y-80--xs g-padding-y-125--sm">
                <div class="g-text-center--xs g-margin-b-100--xs">
                    <h2 style="color: white">Users Location</h2><br><br>
                    <input type="hidden" id="addressinput" value="<%=loc%>"/>
              <div id ="map" style="height: 500px; width: 1140px;" ></div>
</div>
            </div>
        </div>
        <!--========== FOOTER ==========-->
        ...
        <script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?key=AIzaSyCu81ai18DBJeWI5kbbgwXaACXzalYt6kg"></script>
<script language="javascript" type="text/javascript">
    ...
    function getlanval() {
        var latval = '';
        var lngval = '';
        var zipadd = document.getElementById("addressinput").value;
        geocoder.geocode({ 'address': zipadd }, function(valresults, valstatus) {

            if (valstatus == google.maps.GeocoderStatus.OK) {
                latval = valresults[0].geometry.location.lat();
                lngval = valresults[0].geometry.location.lng();
                //alert('Latitude: ' + latval + ' Logitude: ' + lngval);
                document.getElementById("TextBox1").value = latval;
                document.getElementById("TextBox2").value = lngval;
            }
            else {
                alert("Geocode was not successful for the following reason: " + valstatus);
            }
        });
        //alert('Latitude: ' + latval + ' Logitude: ' + lngval);
    }   
