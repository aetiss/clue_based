            ...
            <div class="g-container--sm g-text-center--xs g-padding-y-80--xs g-padding-y-125--xsm">
                ...
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-3 col-xs-10 col-xs-offset-1">
                        <form class="input-group" action="searched_places.jsp" method="get" >
                            <select type="text" class="form-control s-form-v1__input g-radius--left-50" name="search" style="background-color: #5b4670" >
